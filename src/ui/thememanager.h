...
#ifndef PATM_UI_THEMEMANAGER_H
#define PATM_UI_THEMEMANAGER_H

#include "c_backend.h"

namespace PatmThemeManager
{
    void apply(const PatmUiSettings &settings);
    PatmUiSettings current();
    PatmError setTheme(const char *theme, const char *iconTheme);
}
